...
public class AutoSidePositionCommand extends CommandGroup {
    ...
    public AutoSidePositionCommand(String side) {
        ...
        addSequential(new AutoDriveCommand(0.1, 0)); // todo tune this distance
        ...
        if (scaleSide.equals(side)) {
            ...
            addSequential(new AutoDriveCommand(2.0, 0)); // todo tune this distance
            ...
            addSequential(new AutoDriveCommand(1.0, 0)); // todo tune this distance
